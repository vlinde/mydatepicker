...
| __disableWeekdays__   | no default value | Array<string> | Disable weekdays. Array of weekdays to disable. Weekdays are same as __firstDayOfWeek___ option. For example: ['tu', 'we'] which disables Tuesdays and Wednesdays. |
